            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('entries/'.$entry->id) }}" method="POST">
                        @method('PUT')
                        @csrf <!-- token csrf for forms tith post actions -->

                        <div class="form-group">
                            <label for="title">Title</label>

                            <input id="title" type="text" class="form-control @error('title') is-invalid
                                @enderror" name="title" value="{{ old('title', $entry->title) }}"
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="content" class="form-control @error('content') is-invalid
                                @enderror" name="content" required>{{ old('content', $entry->content) }}</textarea>
